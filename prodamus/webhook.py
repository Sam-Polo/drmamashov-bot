    ...
    async def _handle_payment_success(self, user_id: int, data: Dict[str, Any]):
        ...
        try:
            ...
            if not channel_link:
                ...
                channel_link = "Ссылка будет отправлена позже"
            ...
            if is_gift:
                ...
                try:
                    await self.bot.send_message(
                        ...
                        text=f"🎁 Вам подарили подписку!\n\n"
                             f"✅ Подписка активирована\n\n"
                             f"🔗 Ссылка для вступления в закрытый канал:\n{channel_link}\n\n"
                             f"Используй эту ссылку для вступления в канал."
                    )
                except Exception as e:
            ...
            try:
                ...
                if is_gift:
                    payment_text = "✅ Оплата успешно получена!\n\n🎁 Подарок успешно оплачен и активирован для получателя!\n\nПолучателю отправлено уведомление о подарке."
                else:
                    payment_text = f"✅ Оплата успешно получена!\n\n✅ Подписка активирована\n\n🔗 Ссылка для вступления в закрытый канал:\n{channel_link}"
