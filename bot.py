                ...
                try:
                    await bot.send_message(
                        ...
                        text="⏰ Ваш бесплатный период заканчивается завтра!\n\n"
                             "Чтобы продолжить получать рассылку, необходимо подключить подписку.\n\n"
            ...
            if expired_trials:
                ...
                for subscription in expired_trials:
                    ...
                    try:
                        await bot.send_message(
                            chat_id=user_id,
                            text="⏰ Ваш бесплатный период закончился.\n\n"
                                 "Для продолжения рассылки необходимо оформить подписку.\n\n"
                                 "Перейдите в главное меню → раздел 'Подписка' для оформления подписки."
                        )
                    except Exception as e:
